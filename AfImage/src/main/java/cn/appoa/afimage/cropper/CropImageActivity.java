...
public class CropImageActivity extends AppCompatActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        View crop_image_menu_rotate_left = findViewById(R.id.crop_image_menu_rotate_left);
        crop_image_menu_rotate_left.setOnClickListener(this);
        View crop_image_menu_rotate_right = findViewById(R.id.crop_image_menu_rotate_right);
        crop_image_menu_rotate_right.setOnClickListener(this);
        View crop_image_menu_flip_horizontally = findViewById(R.id.crop_image_menu_flip_horizontally);
        crop_image_menu_flip_horizontally.setOnClickListener(this);
        View crop_image_menu_flip_vertically = findViewById(R.id.crop_image_menu_flip_vertically);
        crop_image_menu_flip_vertically.setOnClickListener(this);

        Bundle bundle = getIntent().getBundleExtra(CropImage.CROP_IMAGE_EXTRA_BUNDLE);
        mCropImageUri = bundle.getParcelable(CropImage.CROP_IMAGE_EXTRA_SOURCE);
        mOptions = bundle.getParcelable(CropImage.CROP_IMAGE_EXTRA_OPTIONS);
        if (mOptions.allowRotation) {
            crop_image_menu_rotate_left.setVisibility(View.VISIBLE);
            crop_image_menu_rotate_right.setVisibility(View.VISIBLE);
        }
        if (mOptions.allowFlipping) {
            crop_image_menu_flip_horizontally.setVisibility(View.VISIBLE);
            crop_image_menu_flip_vertically.setVisibility(View.VISIBLE);
        }
...
//	}
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == CropImage.CAMERA_CAPTURE_PERMISSIONS_REQUEST_CODE) {
            // Irrespective of whether camera permission was given or not, we show the
            // picker
    ...
    protected Intent getResultIntent(Uri uri, Exception error, int sampleSize) {
        CropImage.ActivityResult result = new CropImage.ActivityResult(mCropImageView.getImageUri(), uri, error,
                mCropImageView.getCropPoints(), mCropImageView.getCropRect(), mCropImageView.getRotatedDegrees(),
                mCropImageView.getWholeImageRect(), sampleSize);
