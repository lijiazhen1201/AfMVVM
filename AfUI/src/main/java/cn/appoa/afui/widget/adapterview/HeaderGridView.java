 ...
 */
package cn.appoa.afui.widget.adapterview;
 ...
 * {@link ListView}. See
 * {@link HeaderGridView#addHeaderView(View, Object, boolean)} See
 * {@link HeaderGridView#addFooterView(View, Object, boolean)}
 */
public class HeaderGridView extends GridView {
    ...
    /**
     * A class that represents a fixed view in a list, for example a header at the
     * top or a footer at the bottom.
     */
    ...
    /**
     * Add a fixed view to appear at the top of the grid. If addHeaderView is called
     * more than once, the views will appear in the order they were added. Views
     * added using this call can take focus if they want.
     * <p/>
    ...
    public int getRowHeight() {
        ...
        int childWidthSpec = getChildMeasureSpec(MeasureSpec.makeMeasureSpec(mColumnWidth, MeasureSpec.EXACTLY), 0,
                p.width);
    ...
    public void setAdapter(ListAdapter adapter) {
        ...
        if (mHeaderViewInfos.size() > 0 || mFooterViewInfos.size() > 0) {
            HeaderViewGridAdapter headerViewGridAdapter = new HeaderViewGridAdapter(mHeaderViewInfos, mFooterViewInfos,
                    adapter);
            int numColumns = getNumColumnsCompatible();
            if (numColumns > 1) {
    ...
    private class FullWidthFixedViewLayout extends FrameLayout {
        ...
        @Override
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            int targetWidth = HeaderGridView.this.getMeasuredWidth() - HeaderGridView.this.getPaddingLeft()
    ...
    private static class HeaderViewGridAdapter implements WrapperListAdapter, Filterable {
         ...
         * includes the headers and footers, specialized adapters might want a
         * different behavior.
         */
        @Override
