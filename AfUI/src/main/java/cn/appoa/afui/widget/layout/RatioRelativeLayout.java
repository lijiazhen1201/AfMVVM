package cn.appoa.afui.widget.layout;
...
public class RatioRelativeLayout extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            if (ratio <= 0.0f) {
                float ratio_width = array.getFloat(R.styleable.RatioRelativeLayout_ratio_width, 1f);
                float ratio_height = array.getFloat(R.styleable.RatioRelativeLayout_ratio_height, 0f);
                if (ratio_width > 0 && ratio_height >= 0) {
