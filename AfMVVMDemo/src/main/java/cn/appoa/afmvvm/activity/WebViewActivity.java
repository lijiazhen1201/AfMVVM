...
import cn.appoa.afmvvm.databinding.ActivityWebViewBinding;
 ...
 */
public class WebViewActivity extends BaseImageActivity<ActivityWebViewBinding, TitleBarViewModel> {
    ...
    public void initViewObservable() {
        viewModel.setDefaultTitleBar(R.drawable.back_black, "WebView的使用", true);
    }
    ...
    public void initData() {
        ...
        initWebChromeClient();
        //加载网页
        binding.webView.loadUrl(WebViewActivity.baidu_url);
    }
    ...
    protected void initWebSettings() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            mCookieManager.setAcceptThirdPartyCookies(binding.webView, true);
        }
    }
    ...
    protected void initWebChromeClient() {
        binding.webView.setWebChromeClient(new WebChromeClient() {
            ...
            public void onProgressChanged(WebView view, int newProgress) {
                ...
                //获得网页的加载进度并显示
                if (newProgress < 100) {
                    binding.pb.setVisibility(View.VISIBLE);// 开始加载网页时显示进度条
                    binding.pb.setProgress(newProgress);// 设置进度值
                } else {
                    binding.pb.setVisibility(View.GONE);// 加载完网页进度条消失
                }
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgUpload.setOnDismissListener(new DialogInterface.OnDismissListener() {
            @Override
            public void onDismiss(DialogInterface dialog) {
                if (!imgUpload.isConfirm) {
                    // 没有确定
                    clearFileChooser();
                }
            }
    ...
    protected void loadHtmlData(String baseUrl, String data) {
        ...
        data.replace("\\", "");
        binding.webView.loadDataWithBaseURL(baseUrl, data, "text/html", "UTF-8", null);
    }
    ...
    protected void loadHtmlAsset(String fileName) {
        if (binding.webView == null || TextUtils.isEmpty(fileName)) {
            return;
        }
