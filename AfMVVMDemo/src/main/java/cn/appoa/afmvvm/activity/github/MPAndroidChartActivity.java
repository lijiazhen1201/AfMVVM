...
import cn.appoa.afmvvm.databinding.ActivityMpAndroidChartBinding;
 ...
 * Android图表
 */
public class MPAndroidChartActivity extends BaseActivity<ActivityMpAndroidChartBinding, TitleBarViewModel> {
    ...
    public void initViewObservable() {
        viewModel.setDefaultTitleBar(R.drawable.back_black, "MPAndroidChart", true);
    }
