...
import cn.appoa.afutils.listener.ZmShakeListener;
import cn.appoa.afutils.net.LogUtils;

/**
 * 摇一摇页面封装
 */
public abstract class ZmShakeFragment<V extends ViewDataBinding, VM extends BaseViewModel> extends BaseFragment<V, VM>
