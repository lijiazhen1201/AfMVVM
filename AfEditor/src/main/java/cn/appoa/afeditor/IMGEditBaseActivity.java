...
import cn.appoa.afeditor.dialog.IMGFaceEditDialog;
import cn.appoa.afeditor.dialog.IMGTextEditDialog;
import cn.appoa.afeditor.view.IMGColorGroup;
import cn.appoa.afeditor.view.IMGView;

/**
 * 图片编辑基类
 */
public abstract class IMGEditBaseActivity extends Activity implements View.OnClickListener,
        IMGTextEditDialog.Callback, IMGFaceEditDialog.Callback, RadioGroup.OnCheckedChangeListener,
    ...
    private IMGFaceEditDialog mFaceDialog;
    ...
    public void onClick(View v) {
        ...
        if (vid == R.id.rb_doodle) {
            ...
            onDoneClipClick();
        } else if (vid == R.id.ib_clip_reset) {
            onResetClipClick();
    ...
    public void onFaceModeClick() {
        if (mFaceDialog == null) {
            mFaceDialog = new IMGFaceEditDialog(this, this);
            mFaceDialog.setOnShowListener(this);
            mFaceDialog.setOnDismissListener(this);
        }
        mFaceDialog.show();
    }
