package cn.appoa.afeditor.core;
...
import cn.appoa.afeditor.core.clip.IMGClip;
import cn.appoa.afeditor.core.clip.IMGClipWindow;
...
public class IMGImage {
    ...
    private void initShadePaint() {
        if (mShadePaint == null) {
            ...
            mShadePaint.setFilterBitmap(true);
