...
import cn.appoa.afeditor.core.IMGImage;
import cn.appoa.afeditor.core.IMGMode;
import cn.appoa.afeditor.core.IMGPath;
import cn.appoa.afeditor.core.IMGText;
import cn.appoa.afeditor.core.anim.IMGHomingAnimator;
import cn.appoa.afeditor.core.homing.IMGHoming;
import cn.appoa.afeditor.core.sticker.IMGSticker;
import cn.appoa.afeditor.core.sticker.IMGStickerPortrait;
...
public class IMGView extends FrameLayout implements Runnable, ScaleGestureDetector.OnScaleGestureListener,
...

    {
        ...
        mDoodlePaint.setFilterBitmap(true);
        ...
        mMosaicPaint.setFilterBitmap(true);
    ...
    private void onDrawImages(Canvas canvas) {
        ...
        if (!mImage.isMosaicEmpty() || (mImage.getMode() == IMGMode.MOSAIC && !mPen.isEmpty())) {
            ...
            if (mImage.getMode() == IMGMode.MOSAIC && !mPen.isEmpty()) {
                ...
                canvas.drawPath(mPen.getPath(), mMosaicPaint);
                canvas.restore();
            }
    ...
    public void addStickerImage(Bitmap bm) {
