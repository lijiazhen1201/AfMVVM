...
//                resetCaptureLayout();
        ...
        txt_tip.setText(R.string.state_both);
        txt_tip.setTextColor(ContextCompat.getColor(getContext(), R.color.tip_text_color));
        ...
        if (txt_tip != null) {
            switch (state) {
                case JCameraView.BUTTON_STATE_ONLY_CAPTURE:
                    txt_tip.setText(R.string.state_only_capture);
                    break;
                case JCameraView.BUTTON_STATE_ONLY_RECORDER:
                    txt_tip.setText(R.string.state_only_recorder);
                    break;
