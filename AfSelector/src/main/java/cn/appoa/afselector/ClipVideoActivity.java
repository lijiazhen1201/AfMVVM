...
import cn.appoa.afselector.adapter.ClipVideoAdapter;
import cn.appoa.afselector.entry.Data;
import cn.appoa.afselector.entry.Image;
import cn.appoa.afselector.view.range.UIUtil;
import cn.appoa.afselector.view.range.VideoRangeBar;
...
public class ClipVideoActivity extends AppCompatActivity
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.af_selector_activity_clip_video);
    ...
    private void initView() {
        ...
        tv_edit_msg.setText(String.format(getString(R.string.af_selector_clip_video_msg), videoDuration + ""));
