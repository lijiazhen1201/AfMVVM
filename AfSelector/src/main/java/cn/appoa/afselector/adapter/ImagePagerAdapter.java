package cn.appoa.afselector.adapter;
...
import cn.appoa.afselector.utils.ImageUtil;
import cn.appoa.afui.widget.photoview.PhotoView;
import cn.appoa.afui.widget.photoview.PhotoViewAttacher;
...
public class ImagePagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        AfApplication.getImageLoader().downloadImage(image.getPath(), new LoadingBitmapListener() {
            @Override
