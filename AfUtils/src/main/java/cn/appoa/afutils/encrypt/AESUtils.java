package cn.appoa.afutils.encrypt;
...
public class AESUtils {
    ...
    public static String DEFAULT_KEY = "bWFsbHB3ZA==WNST";

    public static String DEFAULT_VALUE = "";

    public static String KEY = "bWFsbHB3ZA==WNST";
    ...
    public static void init(String default_key, String key, String value) {
