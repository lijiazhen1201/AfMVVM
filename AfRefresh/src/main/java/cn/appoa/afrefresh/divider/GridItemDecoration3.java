        ...
        if (isFixedViewType(mAdapter.getItemViewType(position))) {
            ...
            switch (position % 3) {
                case 0:// 左
                    ...
                    decoration.bottom = position >= mAdapter.getData().size() - 3 + 0
                            ? (mMargin ? mHeight : 0) : mHeight;
                    decoration.left = mMargin ? mHeight : 0;
                    decoration.right = mHeight / 2;
                    break;
                case 1:// 中
                    decoration.top = position == 1 ? (mMargin ? mHeight : 0) : 0;
                    decoration.bottom = position >= mAdapter.getData().size() - 3 + 1
                            ? (mMargin ? mHeight : 0) : mHeight;
                ...
                case 2:// 右
                    ...
                    decoration.bottom = position >= mAdapter.getData().size() - 3 + 2
                            ? (mMargin ? mHeight : 0) : mHeight;
                    decoration.left = mHeight / 2;
